...
//       <div className="md:flex items-center justify-between bg-white py-4 md:px-10 px-4 dark:bg-slaate-700">
//         <div
  ...
  return (
    <div className="shadow-md w-full fixed top-0 left-0">
      <div className="md:flex items-center justify-between bg-white dark:bg-primary-97 py-4 md:px-10 px-4">
        ...
        <ul
          className={`dark:bg-primary-97 md:flex md:items-center md:pb-0 pb-4 absolute md:static bg-white md:z-auto z-[-1] left-0 w-full md:w-auto md:pl-0 pl-9 transition-all duration-500 ease-in ${
            open ? "top-10 " : "top-[-490px]"
          }`}
        >
          {Links.map((link) => (
